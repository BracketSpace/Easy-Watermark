			...
			<tr valign="top">
				...
				<td>
					<label for="watermark-autoadd">
						<input id="watermark-autoadd" name="watermark[auto_add]" type="checkbox" value="1" <?php checked( $auto_add ); ?> /> <?php _e( 'Automatically apply this watermark during image upload', 'easy-watermark' ); ?>
					</label>
				</td>
			</tr>
