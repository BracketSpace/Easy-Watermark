...
<div class="preview-metabox">
	...
	<div class="preview-wrap" data-src="<?php echo esc_attr( site_url( sprintf( 'easy-watermark-preview/image-%s.png', $post->ID ) ) ); ?>" data-has-image="<?php echo esc_attr( $has_image ); ?>">
